        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GMeetLink = table.Column<string>(type: "TEXT", nullable: false),
                    BookedAppointmentId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAppointments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserAppointments_BookedAppointments_BookedAppointmentId",
                        column: x => x.BookedAppointmentId,
                        principalTable: "BookedAppointments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserAppointments_Staffs_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAppointments_BookedAppointmentId",
                table: "UserAppointments",
                column: "BookedAppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAppointments_StaffId",
                table: "UserAppointments",
                column: "StaffId");
        }
